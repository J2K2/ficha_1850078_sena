...
if ($_FILES) {
  ...
  $imagen_perfil = $_FILES['archivo'];
  $url_avatar = upload_image($imagen_perfil);
  ...
  if ($url_avatar == null) {
    ...
    $result_update = $connection_bd->prepare($sql_users);
    $result_update -> execute(array($url_avatar, $id_user));

    $_SESSION['usuario_avatar'] = $url_avatar;
